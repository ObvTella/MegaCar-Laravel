...
@section('content')
    ...
    <div class="flex justify-center pt-20">
        <form action="/prenotations/make" method="POST">
            @csrf
            <div class="block">
                ...
                <p class="pb-4 uppercase text-megacar-primary font-bold text-xs">DATA: </p>
                <input type="date" min="{{ date('Y-m-d') }}" class="block shadow-5xl mb-10 p-2 w-80 italic placeholder-gray-400 border border-megacar-primary rounded-md required" name="date"> 
